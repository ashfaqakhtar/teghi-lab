        ...
        <div class="row">
            <div class="col-lg-6 about-section-text ">
                ...
                <p class="section-para">
                    Infectious marker tests are blood tests that detect specific antibodies or antigens
                    produced in response to infections caused by viruses, bacteria, or other pathogens.
                </p>
                <p class="section-para">These tests help identify current or past infections such as HIV, dengue,
                    tuberculosis,
                    and TORCH-related infections that may affect pregnancy and immune health.</p>
                <p class="section-para">Infectious marker testing plays a crucial role in early diagnosis, disease
                    monitoring,
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 about-section-text">
                ...
                <ul>
                    <li class="list-font">Individuals with suspected viral or infectious diseases</li>
                    <li class="list-font">Patients with prolonged fever or unexplained symptoms</li>
                    <li class="list-font">Pregnant women undergoing TORCH screening </li>
                    <li class="list-font">Individuals at risk of HIV or other viral infections</li>
                    <li class="list-font">Patients advised infectious marker testing by doctors </li>
                    <li class="list-font">Routine health screening or preventive checkups</li>
                </ul>
            </div>
