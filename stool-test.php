        ...
        <div class="row">
            <div class="col-lg-6 about-section-text ">
                ...
                <p class="section-para">
                    Stool tests analyze the physical, chemical, and microscopic characteristics of stool
                    to assess digestive system health and identify gastrointestinal conditions.
                </p>
                <p class="section-para">These tests help detect intestinal infections, parasitic infestations,
                    inflammation,
                    occult (hidden) blood, and other digestive disorders. Stool examination also aids in
                    diagnosing causes of diarrhea, abdominal pain, and unexplained weight loss.</p>
                <p class="section-para">Stool testing plays an important role in routine health screening,
                    gastrointestinal
        ...
        <div class="row">
            <div class="col-lg-6 about-section-text">
                ...
                <ul>
                    ...
                    <li class="list-font">Pre-employment or preventive health checkups </li>
                </ul>
            </div>
