...
<section>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 about-section-text ">
                ...
                <p class="section-para">
                    Serological tests are blood tests that detect antibodies, antigens, and immune responses in the
                    body.
                    These tests help identify current or past infections, autoimmune conditions, and immune system
                    disorders.
                </p>
                <p class="section-para">Serological testing is widely used to diagnose bacterial and viral infections,
                    inflammatory conditions,
                    and immune-related diseases. It plays an important role in understanding how the body responds to
                    infections.</p>
                <p class="section-para">These tests are essential for early detection, treatment planning, and routine
    ...
    <div class="container">
        ...
        <div class="row mt-2 test-list">
            <div class="col-lg-6">
                <ul>
                    <li class="list-font">VDRL</li>
                    <li class="list-font">Widal Test</li>
                    <li class="list-font">Aso Titre</li>
                    <li class="list-font">CRP</li>
            ...
            <div class="col-lg-6">
                <ul>
                    <li class="list-font">RA Test</li>
                    <li class="list-font">Urine Pregnancy Test</li>
                    <li class="list-font">Mantoux Test</li>
                </ul>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 about-section-text">
                ...
                <ul>
                    <li class="list-font">Individuals with fever of unknown origin </li>
                    <li class="list-font">Patients with suspected bacterial or viral infections </li>
                    <li class="list-font">People experiencing frequent illness or weak immunity</li>
                    <li class="list-font">Individuals being evaluated for autoimmune or inflammatory conditions</li>
                    <li class="list-font">Pre-employment, pre-surgical, or routine health checkups </li>
                </ul>
            </div>
